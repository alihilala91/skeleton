...
public class ExerciseStatus {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "exercise_status_gen")
    @SequenceGenerator(name = "exercise_status_gen", sequenceName = "exercise_status_seq",
